...
class Toggle extends React.Component {
  ...
  // some use cases where users won't want to initialize...hence defaultProps
  ...
  // KEVIN: the static defaultProps trickles down as regular props
  // Kent C. Dodds says this is more communicative of what's going on
